...
import 'package:onboarding/onboarding1/model/onboard_page_item.dart';
import 'package:onboarding/onboarding1/components/fading_sliding_widget.dart';
import 'package:onboarding/onboarding1/screens/onboard/welcome_page.dart';
import 'package:onboarding/onboarding1/screens/onboard/onboard_page.dart';
...
class _OnboardState extends State<Onboard> with SingleTickerProviderStateMixin {
  List<OnboardPageItem> onboardPageItems = [
    OnboardPageItem(
      lottieAsset: 'assets/onboarding1/animations/video_call.json',
      text: 'Check out this animation from flutter speed code',
    ),
    OnboardPageItem(
      lottieAsset: 'assets/onboarding1/animations/work_from_home.json',
      text: 'You can download it from guthub for free',
      animationDuration: const Duration(milliseconds: 1100),
    ),
    OnboardPageItem(
      lottieAsset: 'assets/onboarding1/animations/group_working.json',
      text: 'These templates are available for free!!',
    ),
  ];
