    ...
    return Scaffold(
      body: Stack(
        ...
        children: <Widget>[
          Positioned.fill(
            child: Image.asset(
              'assets/onboarding1/images/background.png',
              fit: BoxFit.fill,
            ),
          ),
          Positioned(
              ...
              children: <Widget>[
                    ...
                    child: ScaleTransition(
                      scale: _animationController.drive(
                        Tween<double>(begin: 1.3, end: 1.0).chain(
                          CurveTween(
                            curve:
                                Interval(0.2, 0.4, curve: Curves.elasticInOut),
                          ),
                        ),
                      ),
                      child: Container(
                        ...
                        child: Image.asset(
                          'assets/onboarding1/images/video.png',
                          scale: 0.9,
                        ),
                      ),
                    ),
                ...
                Container(
                  ...
                  child: FadingSlidingWidget(
                    ...
                    child: Text(
                      'Learn more about flutter speed code',
                      style: TextStyle(
                        color: const Color(0xFFFFFFFF),
